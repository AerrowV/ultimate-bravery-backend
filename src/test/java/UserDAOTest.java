...
class UserDAOTest extends DAOTestBase {
    ...
    void setUp() {
        ...
        testUser = new User("testuser1", "password123");
    ...
    void testGetVerifiedUser() throws ValidationException {
        var verifiedUser = userDAO.getVerifiedUser("testuser1", "password123");
        assertNotNull(verifiedUser);
        assertEquals("testuser1", verifiedUser.getUsername());
        assertThrows(ValidationException.class, () ->
                userDAO.getVerifiedUser("testuser1", "wrongpassword"));
    ...
    void testPasswordHashing() {
        try (EntityManager em = emf.createEntityManager()) {
            User foundUser = em.find(User.class, "testuser1");
